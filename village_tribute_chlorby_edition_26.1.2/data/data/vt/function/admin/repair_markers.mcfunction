...
execute as @e[type=minecraft:marker,tag=vt_tribute_barrel] run scoreboard players add #markers_before vt_runtime 1

function vt:cleanup/deduplicate_all

execute as @e[type=minecraft:marker,tag=vt_tribute_barrel] run scoreboard players add #markers_after vt_runtime 1
