...
# The day lock makes automatic collection idempotent. Even if vt:tick is registered
# more than once, only the first trigger for this Minecraft day can collect taxes.
