...
execute unless entity @e[type=minecraft:marker,tag=vt_status_target,limit=1] run tellraw @s {"text":"[Village Tribute] No tribute barrel was found within 128 blocks.","color":"red"}
